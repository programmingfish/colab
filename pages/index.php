...
<div class="middle">
      <div id="login">
        ...
        <form action="javascript:void(0);" method="get" target="login/check.php">
          ...
          <fieldset class="clearfix">
            ...
            <p><span class="fa fa-lock"></span><input type="password"  Placeholder="Password" required></p> <!-- JS because of IE support; better: placeholder="Password" -->
             ...
             <div>
                                <span style="width:48%; text-align:left;  display: inline-block;"><a class="small-text" href="#" onclick="javascript:alert('Ask help to your admin!')">Forgot
                                password?</a></span>
